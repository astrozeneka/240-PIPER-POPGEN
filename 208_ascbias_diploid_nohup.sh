...
IN_PHY="results/207_vcf2phylip_diploid/all_diploid.min4.phy"
OUTDIR="results/208_ascbias_diploid"
...
OUT_LOG="logs/208_ascbias_$$.out"
ERR_LOG="logs/208_ascbias_$$.err"
